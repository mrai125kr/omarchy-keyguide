...
const messages = {
  ...
  "shortcut.typeRoleColumn": ["Type / Role", "유형 / 역할", "種類 / 役割", "类型 / 角色", "Tipo / Rol"],
  ...
  "shortcut.filterTitle": ["Find registered shortcuts", "등록된 단축키 찾기", "登録済みショートカットを検索", "查找已注册的快捷键", "Buscar atajos registrados"],
  "shortcut.filterHelp": ["Search every registered title, key, type, and role, or select one modifier group.", "등록된 모든 제목·키·유형·역할을 검색하거나 조합키 하나를 선택하세요.", "登録済みのタイトル、キー、種類、役割をすべて検索するか、修飾キーグループを1つ選択してください。", "搜索所有已注册的标题、按键、类型和角色，或选择一个修饰键组合。", "Busca en todos los títulos, teclas, tipos y roles registrados, o selecciona un grupo de modificadores."],
  "shortcut.filterPlaceholder": ["Search title, key, or type", "제목, 키 또는 유형 검색", "タイトル、キー、種類を検索", "搜索标题、按键或类型", "Buscar título, tecla o tipo"],
  "shortcut.filterIdle": ["Enter a search term or select a modifier group.", "검색어를 입력하거나 조합키를 선택하세요.", "検索語を入力するか、修飾キーグループを選択してください。", "请输入搜索词或选择修饰键组合。", "Introduce una búsqueda o selecciona un grupo de modificadores."],
  "shortcut.filterNoResults": ["No registered shortcuts match these conditions.", "조건에 맞는 등록 단축키가 없습니다.", "条件に一致する登録済みショートカットはありません。", "没有符合条件的已注册快捷键。", "Ningún atajo registrado coincide con estas condiciones."],
  "shortcut.filterResultCount": ["{count} shown · {total} total", "결과 {count}개 · 전체 {total}개", "{count}件表示・全{total}件", "显示 {count} 个 · 共 {total} 个", "{count} mostrados · {total} en total"],
  ...
  "search.placeholder": ["Search apps or actions", "앱 또는 행동 검색", "アプリまたは操作を検索", "搜索应用或操作", "Busca aplicaciones o acciones"],
  ...
  "search.category.action": ["Registered actions", "등록된 액션", "登録済みアクション", "已注册操作", "Acciones registradas"],
  "search.category.command": ["Commands", "명령", "コマンド", "命令", "Comandos"],
  "search.cmdBadge": ["CMD", "CMD", "CMD", "CMD", "CMD"],
  "search.desktopAppBadge": ["DESKTOP APP", "데스크톱 앱", "デスクトップアプリ", "桌面应用", "APP DE ESCRITORIO"],
  "search.webAppBadge": ["WEB APP", "웹앱", "ウェブアプリ", "网页应用", "APP WEB"],
  "search.agentBadge": ["AGENT", "에이전트", "エージェント", "智能助手", "AGENTE"],
  "search.browserBadge": ["BROWSER", "브라우저", "ブラウザ", "浏览器", "NAVEGADOR"],
  "search.editorBadge": ["EDITOR", "에디터", "エディター", "编辑器", "EDITOR"],
  "search.actionBadge": ["ACTION", "행동", "操作", "操作", "ACCIÓN"],
  "search.systemUiBadge": ["SYSTEM UI", "시스템 UI", "システムUI", "系统界面", "SISTEMA"],
  ...
  "search.refreshing": ["Refreshing installed apps and actions…", "설치된 앱과 행동을 새로 확인하는 중…", "インストール済みアプリと操作を更新しています…", "正在刷新已安装的应用和操作…", "Actualizando las aplicaciones y acciones instaladas…"],
  ...
  "error.inputAccess": ["Keyguide cannot read keyboard input. Complete the one-time input-access setup, then restart Omarchy Shell.", "키가이드가 키보드 입력을 읽을 권한이 없습니다. 입력 접근을 한 번 설정한 뒤 Omarchy Shell을 다시 시작하세요.", "キーガイドにキーボード入力を読み取る権限がありません。入力アクセスを一度設定してから、Omarchy Shellを再起動してください。", "快捷键指南没有读取键盘输入的权限。请完成一次性输入访问设置，然后重启 Omarchy Shell。", "La guía no tiene permiso para leer el teclado. Configura el acceso de entrada una vez y reinicia Omarchy Shell."],
  ...
  "error.catalogLoad": ["Apps and actions could not be loaded. Refresh to try again.", "앱과 행동을 불러오지 못했습니다. 새로고침하여 다시 시도하세요.", "アプリと操作を読み込めませんでした。更新してもう一度お試しください。", "无法加载应用和操作。请刷新后重试。", "No se pudieron cargar las aplicaciones y acciones. Actualiza para intentarlo de nuevo."],
